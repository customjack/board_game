...
import TurnBasedGameState from '../../game/engine_types/turn_based/state/TurnBasedGameState.js';
...
import { builtInPlaceholderTypes, registerBuiltInPlaceholders } from '../../elements/placeholders/BuiltInPlaceholders.js';
...
export default class DefaultCorePlugin extends Plugin {
    ...
    _registerPlaceholders(registryManager) {
        ...
        try {
            return registerBuiltInPlaceholders(placeholderRegistry);
        } catch (error) {
    ...
    static getPluginMetadata() {
        return {
            ...
            provides: {
                ...
                placeholders: [
                    ...builtInPlaceholderTypes.map((PlaceholderType) => PlaceholderType.type)
                ],
                components: [
